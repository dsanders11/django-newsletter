...
class ImportForm(forms.Form):
    ...
    def clean(self):
        ...
        for field in ('address_file', 'ignore_errors', 'newsletter'):
        ...
        myfield = self.fields['address_file']
...
class SubscriptionAdminForm(forms.ModelForm):
    ...
    def clean(self):
        ...
        if not (cleaned_data.get('user') or cleaned_data.get('email_field')):
            raise forms.ValidationError(_(
...
class SubmissionAdminForm(forms.ModelForm):
    # TODO - This only works because 'message' is before 'publish' alphabetically
